try{var dv_win = window._dv_win || window.parent._dv_win; dv_win['dvCallback_1529720472286537']($dv,window,'c991b6ee5c304248930fe1e177a2cd03','tps11012.doubleverify.com');}catch(e){try{var image=window.document.createElement('img');image.src=window.location.protocol+'//tps30.doubleverify.com/visit.jpg?ctx=818052&cmp=1619415&dvtagver=6.1.src&dvp_cbError='+encodeURIComponent(e.message)}catch(e){}}$dv.pubSub.subscribe('ImpressionServed', $uid, 'RTN_LatencyTemp', function () {try {var beforeVisitCall = '';var templateStartTime = parent.getCurrentTime();var dv_win = parent.window._dv_win;if (dv_win && dv_win.t2tTimestampData) {if (dv_win.t2tTimestampData.length >= 2) {beforeVisitCall = dv_win.t2tTimestampData[1].beforeVisitCall;}}var latency = 0;if (beforeVisitCall != '' && templateStartTime != '') {latency = templateStartTime - beforeVisitCall;}if(latency > 1000 && latency < 90000) {$dv.registerEventCall($uid, { dvp_ltncy: latency });}} catch (e) {};});$dv.tags[$uid].cbust = 'mpt';$dv.pubSub.subscribe('ImpressionServed', 'c991b6ee5c304248930fe1e177a2cd03', 'RTN_ImpressionServed', function(){ var tagServiceUrl = decodeURIComponent('https://adfarm.mediaplex.com/ad/sv/[DVP_PLCD]?mpcr=[CRT]&dv_monitored_impressions=1&mpt='); tagServiceUrl = $dv.resolveMacros(tagServiceUrl, $dv.tags['c991b6ee5c304248930fe1e177a2cd03']);  $dv.domUtilities.addImage(tagServiceUrl, $dv.tags['c991b6ee5c304248930fe1e177a2cd03'].tagElement.parentElement,1);});$dv.pubSub.subscribe('ImpressionServed', 'c991b6ee5c304248930fe1e177a2cd03', 'RTN_ImpressionServed', function(){ var tagServiceUrl = decodeURIComponent('https://adfarm.mediaplex.com/ad/sv/[DVP_PLCD]?mpcr=[CRT]&dv_authentic_impressions=1&mpt='); tagServiceUrl = $dv.resolveMacros(tagServiceUrl, $dv.tags['c991b6ee5c304248930fe1e177a2cd03']);  $dv.domUtilities.addImage(tagServiceUrl, $dv.tags['c991b6ee5c304248930fe1e177a2cd03'].tagElement.parentElement,1);});$dv.pubSub.subscribe('IABMeasuredImpression', 'c991b6ee5c304248930fe1e177a2cd03', 'RTN_IABMeasuredImpression', function(){ var tagServiceUrl = decodeURIComponent('https://adfarm.mediaplex.com/ad/sv/[DVP_PLCD]?mpcr=[CRT]&dv_measured_impressions=1&mpt='); tagServiceUrl = $dv.resolveMacros(tagServiceUrl, $dv.tags['c991b6ee5c304248930fe1e177a2cd03']);  $dv.domUtilities.addImage(tagServiceUrl, $dv.tags['c991b6ee5c304248930fe1e177a2cd03'].tagElement.parentElement,1);});$dv.pubSub.subscribe('IABViewableImpression', 'c991b6ee5c304248930fe1e177a2cd03', 'RTN_IABViewableImpression', function(){ var tagServiceUrl = decodeURIComponent('https://adfarm.mediaplex.com/ad/sv/[DVP_PLCD]?mpcr=[CRT]&dv_viewable_impressions=1&mpt='); tagServiceUrl = $dv.resolveMacros(tagServiceUrl, $dv.tags['c991b6ee5c304248930fe1e177a2cd03']);  $dv.domUtilities.addImage(tagServiceUrl, $dv.tags['c991b6ee5c304248930fe1e177a2cd03'].tagElement.parentElement,1);});$dv.pubSub.subscribe('IABViewableImpression', 'c991b6ee5c304248930fe1e177a2cd03', 'RTN_IABViewableImpression', function(){ var tagServiceUrl = decodeURIComponent('https://adfarm.mediaplex.com/ad/sv/[DVP_PLCD]?mpcr=[CRT]&dv_authentic_viewable_impressions=1&mpt='); tagServiceUrl = $dv.resolveMacros(tagServiceUrl, $dv.tags['c991b6ee5c304248930fe1e177a2cd03']);  $dv.domUtilities.addImage(tagServiceUrl, $dv.tags['c991b6ee5c304248930fe1e177a2cd03'].tagElement.parentElement,1);});    	$dv.pubSub.subscribe ('ImpressionServed', $uid, 'SendAdEntitiesForBSBAConsolidation', function() {
            'use strict';
            ...
            var bsmsg = {
                ...
                bsAdEntityInformation : {
                    comparisonItems : [{name : 'cmp', value : 12961764},{name : 'plmt', value : 12961867}], verboseReporting : true  }
            };
