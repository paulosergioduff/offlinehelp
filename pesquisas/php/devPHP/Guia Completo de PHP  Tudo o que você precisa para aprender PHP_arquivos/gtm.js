...
"resource": {
  ...
  "rules":[
    ...
    [["if",28,31],["unless",30],["add",28,29]],
    [["if",28,32],["unless",30],["add",30]],
    [["if",28,33],["unless",30],["add",30]]]
},
"runtime":[
[],[]
]};
...
var gc={},hc=null;gc.m="GTM-MCHBV6W";var ic=null,jc="//www.googletagmanager.com/a?id="+gc.m+"&cv=78",kc={},lc={};var mc=function(){},nc=function(a){return"function"==typeof a},oc=function(a){return"string"==ta(a)},pc=function(a){return"number"==ta(a)&&!isNaN(a)},qc=function(a){return Math.round(Number(a))||0},rc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},sc=function(a){var b=[];if(oa(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},tc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},uc=function(a,b){if(!pc(a)||!pc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
...
var rg=function(a,b,c){a instanceof ge.jc&&(a=a.resolve(ge.Nd(b,c)),b=mc);return{Xa:a,H:b}};var sg=function(a,b){var c=(new Date).getTime();this.n=a;this.t=c;this.p=b},tg=function(){this.c=1;this.e=[];this.p=null};function ug(a){var b=hc,c=b.gss=b.gss||{};return c[a]=c[a]||new tg}var vg=function(a,b){ug(a).p=b},wg=function(a){};var Bg=function(a){if(1===ug(a).c){ug(a).c=2;var b=encodeURIComponent(a);J("www.googletagmanager.com/gtag/js?id="+b+"&l=dataLayer&cx=c")}},Cg=function(a,b){};var Z={a:{}};Z.a.ctv=["google"],function(){(function(a){Z.__ctv=a;Z.__ctv.b="ctv";Z.__ctv.g=!0})(function(){return"78"})}();
