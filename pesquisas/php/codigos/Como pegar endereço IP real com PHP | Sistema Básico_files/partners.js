...
_oiqq.push(['oiq_addPageBrand', 'MySQL']);
...
(function() {
  var shrLoccLoader = setInterval(function() {
    if (document.body) {
      ...
      locc_pixel.src = document.location.protocol + "//sync.crwdcntrl.net/map/c=9193/tp=SHLC/tpid=6ecbb42e-92ea-4e46-a5fd-57edec252486";
...
(function() {
    ...
    locc_human.src = document.location.protocol + '//n-cdn.areyouahuman.com/play/YNMJrK4lsMAJlxSsJDb17LW8YmmHRLakZxkWagp6?AYAH_F2=sistemabasico.com.br&AYAH_P2=6ecbb42e-92ea-4e46-a5fd-57edec252486&AYAH_F1=Lotame';
  ...
  var bkInt = setInterval(function(){
    if(document.body){
      ...
      bksrc.onload = function() {
                ...
                bk_addPageCtx("sh001", "10930629");
                bk_addPageCtx("sh001", "13594624");
                ...
                bk_addPageCtx("sh005", "6573695");
                bk_addPageCtx("sh004", "8762415");
                bk_addPageCtx("sh005", "6573714");
                bk_doJSTag(41110, 1);
      };
