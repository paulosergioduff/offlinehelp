try{var dv_win = window._dv_win || window.parent._dv_win; dv_win['dvCallback_1529953092261508']($dv,window,'e7cfd7be265e4a54968f52293e890619','tps10204.doubleverify.com');}catch(e){try{var image=window.document.createElement('img');image.src=window.location.protocol+'//tps30.doubleverify.com/visit.jpg?ctx=818052&cmp=1619415&dvtagver=6.1.src&dvp_cbError='+encodeURIComponent(e.message)}catch(e){}}$dv.pubSub.subscribe('ImpressionServed', $uid, 'RTN_LatencyTemp', function () {try {var beforeVisitCall = '';var templateStartTime = parent.getCurrentTime();var dv_win = parent.window._dv_win;if (dv_win && dv_win.t2tTimestampData) {if (dv_win.t2tTimestampData.length >= 2) {beforeVisitCall = dv_win.t2tTimestampData[1].beforeVisitCall;}}var latency = 0;if (beforeVisitCall != '' && templateStartTime != '') {latency = templateStartTime - beforeVisitCall;}if(latency > 1000 && latency < 90000) {$dv.registerEventCall($uid, { dvp_ltncy: latency });}} catch (e) {};});$dv.tags[$uid].cbust = 'mpt';$dv.pubSub.subscribe('ImpressionServed', 'e7cfd7be265e4a54968f52293e890619', 'RTN_ImpressionServed', function(){ var tagServiceUrl = decodeURIComponent('https://adfarm.mediaplex.com/ad/sv/[DVP_PLCD]?mpcr=[CRT]&dv_monitored_impressions=1&mpt='); tagServiceUrl = $dv.resolveMacros(tagServiceUrl, $dv.tags['e7cfd7be265e4a54968f52293e890619']);  $dv.domUtilities.addImage(tagServiceUrl, $dv.tags['e7cfd7be265e4a54968f52293e890619'].tagElement.parentElement,1);});$dv.pubSub.subscribe('ImpressionServed', 'e7cfd7be265e4a54968f52293e890619', 'RTN_ImpressionServed', function(){ var tagServiceUrl = decodeURIComponent('https://adfarm.mediaplex.com/ad/sv/[DVP_PLCD]?mpcr=[CRT]&dv_authentic_impressions=1&mpt='); tagServiceUrl = $dv.resolveMacros(tagServiceUrl, $dv.tags['e7cfd7be265e4a54968f52293e890619']);  $dv.domUtilities.addImage(tagServiceUrl, $dv.tags['e7cfd7be265e4a54968f52293e890619'].tagElement.parentElement,1);});$dv.pubSub.subscribe('IABMeasuredImpression', 'e7cfd7be265e4a54968f52293e890619', 'RTN_IABMeasuredImpression', function(){ var tagServiceUrl = decodeURIComponent('https://adfarm.mediaplex.com/ad/sv/[DVP_PLCD]?mpcr=[CRT]&dv_measured_impressions=1&mpt='); tagServiceUrl = $dv.resolveMacros(tagServiceUrl, $dv.tags['e7cfd7be265e4a54968f52293e890619']);  $dv.domUtilities.addImage(tagServiceUrl, $dv.tags['e7cfd7be265e4a54968f52293e890619'].tagElement.parentElement,1);});$dv.pubSub.subscribe('IABViewableImpression', 'e7cfd7be265e4a54968f52293e890619', 'RTN_IABViewableImpression', function(){ var tagServiceUrl = decodeURIComponent('https://adfarm.mediaplex.com/ad/sv/[DVP_PLCD]?mpcr=[CRT]&dv_viewable_impressions=1&mpt='); tagServiceUrl = $dv.resolveMacros(tagServiceUrl, $dv.tags['e7cfd7be265e4a54968f52293e890619']);  $dv.domUtilities.addImage(tagServiceUrl, $dv.tags['e7cfd7be265e4a54968f52293e890619'].tagElement.parentElement,1);});$dv.pubSub.subscribe('IABViewableImpression', 'e7cfd7be265e4a54968f52293e890619', 'RTN_IABViewableImpression', function(){ var tagServiceUrl = decodeURIComponent('https://adfarm.mediaplex.com/ad/sv/[DVP_PLCD]?mpcr=[CRT]&dv_authentic_viewable_impressions=1&mpt='); tagServiceUrl = $dv.resolveMacros(tagServiceUrl, $dv.tags['e7cfd7be265e4a54968f52293e890619']);  $dv.domUtilities.addImage(tagServiceUrl, $dv.tags['e7cfd7be265e4a54968f52293e890619'].tagElement.parentElement,1);});    	$dv.pubSub.subscribe ('ImpressionServed', $uid, 'SendAdEntitiesForBSBAConsolidation', function() {
            'use strict';
